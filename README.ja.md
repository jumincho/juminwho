...
<picture>
  ...
  <img src="docs/preview-light.jpg" alt="最初の画面：クリーム色の背景に名前とプロフィールカード、その横に桜の下で撮った写真とパンダのマスコット" />
</picture>
...
- 丸太に前足をかけた、もふもふの子パンダのマスコット、Mongle。ファビコン、アプリアイコン、リンクプレビュー（Open Graph）画像はすべてこの絵から作られます。
